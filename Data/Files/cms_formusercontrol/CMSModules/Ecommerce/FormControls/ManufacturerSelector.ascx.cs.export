...
public partial class CMSModules_Ecommerce_FormControls_ManufacturerSelector : SiteSeparatedObjectSelector
{
    ...
    {
        ManufacturerInfo manufacturerInfoObj = ManufacturerInfoProvider.GetManufacturerInfo(name, siteName);

        return (manufacturerInfoObj != null) ? manufacturerInfoObj.ManufacturerID : 0;
    }
