...
public partial class CMSWebParts_Community_Forums_ForumGroupList : CMSAbstractWebPart
{
    ...
    /// </summary>
    public bool EnableFriendship
    {
        get
        {
            return ValidationHelper.GetBoolean(GetValue("EnableFriendship"), ForumDivider1.EnableFriendship);
        }
        set
        {
            SetValue("EnableFriendship", value);
            ForumDivider1.EnableFriendship = value;
        }
    }
