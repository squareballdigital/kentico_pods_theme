...
public partial class CMSWebParts_Community_UserContributions_GroupContributionList : CMSAbstractWebPart
{
    ...
    /// <summary>
    /// Gets or sets the value that indicates whether group permissions should be checked.
    /// </summary>
    public bool CheckGroupPermissions
    {
        get
        {
            return ValidationHelper.GetBoolean(GetValue("CheckGroupPermissions"), list.CheckGroupPermissions);
        }
        set
        {
            SetValue("CheckGroupPermissions", value);
            list.CheckGroupPermissions = value;
        }
    }
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            list.CheckGroupPermissions = CheckGroupPermissions;
