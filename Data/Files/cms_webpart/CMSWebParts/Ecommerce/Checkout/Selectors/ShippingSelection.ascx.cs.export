...
public partial class CMSWebParts_Ecommerce_Checkout_Selectors_ShippingSelection : CMSCheckoutWebPart
{
    ...
    protected void HandlePreselectShippingOption()
    {
        ...
        if ((ShoppingCart.ShoppingCartShippingOptionID <= 0) && (customer != null))
        {
            var shippingOptionId = Customer.GetPreferences(ShoppingCart.ShoppingCartSiteID).ShippingOptionID ?? 0;
