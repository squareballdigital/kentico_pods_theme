...
public partial class CMSWebParts_Media_Video : CMSAbstractWebPart
{
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                builder.Append("<param name=\"filename\" value=\"", HTMLHelper.HTMLEncode(UrlResolver.ResolveUrl(VideoURL)), "\" />");
                builder.Append("<param name=\"src\" value=\"", HTMLHelper.HTMLEncode(UrlResolver.ResolveUrl(VideoURL)), "\" />");
                ...
                builder.Append("<object type=\"application/x-mplayer2\" src=\"", HTMLHelper.HTMLEncode(UrlResolver.ResolveUrl(VideoURL)), "\" name=\"", ClientID, "\" width=\"", Width, "\" height=\"", Height, "\" autostart=\"", autoStart, "\"  wmode=\"transparent\">\n");
    ...
    private string BuildScriptBlock(int showControls, int autoStart, int loop)
    {
        string scriptBlock = string.Format("LoadVideo('VideoPlaceholder_{0}', '{1}', {2}, {3}, '{4}', '{5}', '{6}', {7});",
                                           ltlScript.ClientID,
                                           HTMLHelper.HTMLEncode(UrlResolver.ResolveUrl(VideoURL)),
                                           Width,
                                           Height,
                                           showControls,
                                           autoStart,
